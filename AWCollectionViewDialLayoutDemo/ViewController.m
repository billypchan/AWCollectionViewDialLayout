...
@property (weak, nonatomic) IBOutlet UILabel *lblTemp100;
@property (weak, nonatomic) IBOutlet UILabel *lblTemp50;
@property (weak, nonatomic) IBOutlet UILabel *lblTemp0;
...
- (void)viewDidLoad
{
  ...
  dialLayout.viewController = self;
...
-(void)buildSettings{
  ...
  exampleSwitch.selectedSegmentIndex = 1;
}
